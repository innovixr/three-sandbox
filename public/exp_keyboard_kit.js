...
class Experience {
	...
	constructor() {
		...
		//this.keyboard = new KIT.widgets.Keyboard( this.app );
		this.keyboard.mesh.position.set( 0, 1.4, 0 );
		this.keyboard.mesh.rotation.set( -0.5, 0, 0 );
		this.app.add( this.keyboard );
